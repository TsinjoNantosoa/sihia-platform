...
**Source** : dépôt [`sihia-platform`](../../sihia-platform/) — 68 tests pytest, 8 E2E Playwright, ~95 % MVP fonctionnel.
...
- [sihia-platform/Document/README_ETAT_IMPLEMENTATION.md](../../sihia-platform/Document/README_ETAT_IMPLEMENTATION.md)
