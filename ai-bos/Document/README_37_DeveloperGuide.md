...
**Héritage** : le projet démarre par l'extraction du dépôt [`sihia-platform`](../../sihia-platform/) — référez-vous à [README_35_MigrationFromSIHIA](README_35_MigrationFromSIHIA.md).
