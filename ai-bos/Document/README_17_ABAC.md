...
| **Référence héritage** | [SIH IA facility claim](../../sihia-platform/backend/app/application/use_cases.py) · [SIH IA require_permission](../../sihia-platform/backend/app/presentation/deps.py) |
