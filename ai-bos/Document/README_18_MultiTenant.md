...
| **Référence héritage** | [SIH IA facility](../../sihia-platform/backend/app/application/use_cases.py) · [SIH IA single-tenant MVP](../../sihia-platform/Document/README_ETAT_IMPLEMENTATION.md) |
