...
> **Référence héritage:** [notification_channels.py](../../sihia-platform/backend/app/infrastructure/notification_channels.py), [reminder_service.py](../../sihia-platform/backend/app/application/reminder_service.py)
