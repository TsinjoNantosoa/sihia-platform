...
- [x] Rendez-vous — recherche et filtres combinés, vues sauvegardées par utilisateur et raccourci « Mon service » configurable
- [x] Rendez-vous — file hors ligne par utilisateur pour statut, déplacement, annulation et rappel, avec rejeu ordonné à la reconnexion
...
| Rendez-vous | ✅ | Conflits, rappels, workflow, calendrier, vues sauvegardées et file hors ligne synchronisée |
