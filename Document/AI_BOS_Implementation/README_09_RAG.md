...
> **Référence héritage:** [SIH IA chatbot_knowledge.json](../../backend/data/chatbot_knowledge.json), [ChatbotService._retrieve_context](../../backend/app/application/chatbot_service.py)
...
- [SIH IA chatbot_knowledge.json](../../backend/data/chatbot_knowledge.json)
