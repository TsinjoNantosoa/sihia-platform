...
| **Référence héritage** | [SIH IA ROLE_PERMISSIONS](../../backend/app/application/use_cases.py) · [SIH IA rbac.ts](../../src/lib/auth/rbac.ts) · [SIH IA require_permission](../../backend/app/presentation/deps.py) |
