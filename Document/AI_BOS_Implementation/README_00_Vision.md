...
| **Référence héritage** | [SIH IA — État d'implémentation](../../Document/README_ETAT_IMPLEMENTATION.md) |
...
| Document | Lien |
|----------|------|
| État d'implémentation | [README_ETAT_IMPLEMENTATION.md](../../Document/README_ETAT_IMPLEMENTATION.md) |
| Architecture SIH IA | [README_02_Architecture.md](../../Document/README_02_Architecture.md) |
| Pipeline Airflow | [README_AIRFLOW_UTILISATION.md](../../Document/README_AIRFLOW_UTILISATION.md) |
