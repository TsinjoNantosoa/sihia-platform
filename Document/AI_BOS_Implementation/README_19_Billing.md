...
| **Référence héritage** | [SIH IA analytics revenue](../../backend/app/presentation/routes.py) · [SIH IA ChatbotRateLimiter metering pattern](../../backend/app/presentation/chatbot_rate_limit.py) |
