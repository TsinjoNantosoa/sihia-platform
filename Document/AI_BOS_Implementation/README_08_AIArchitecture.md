...
> **Référence héritage:** [SIH IA Chatbot](../../backend/app/application/chatbot_service.py), [Guardrails](../../backend/app/application/chatbot_guardrails.py)
...
- [SIH IA chatbot_guardrails.py](../../backend/app/application/chatbot_guardrails.py)
