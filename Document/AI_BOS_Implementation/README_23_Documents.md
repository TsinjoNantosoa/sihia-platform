...
> **Référence héritage:** [routes.py export PDF/Excel](../../backend/app/presentation/routes.py), [test_exports.py](../../backend/tests/test_exports.py), [README_22_Search](README_22_Search.md)
