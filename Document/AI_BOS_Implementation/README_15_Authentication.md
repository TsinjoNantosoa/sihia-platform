...
| **Référence héritage** | [SIH IA AuthService](../../backend/app/application/use_cases.py) · [SIH IA security.py](../../backend/app/core/security.py) · [SIH IA auth store](../../src/lib/auth/store.ts) |
