...
export default function App() {
  const apiBaseUrl =
    ...
    "http://127.0.0.1:8001";
  const clientId =
    import.meta.env.VITE_CLIENT_ID?.trim() || readRuntimeVar("__CHATBOT_CLIENT_ID__") || "aaa";
  // Secret serveur uniquement via injection runtime (jamais VITE_*)
  const apiToken = readRuntimeVar("__CHATBOT_API_TOKEN__");
  ...
  const theme: ClientTheme = {
    ...
    primaryColor:
      ...
      readRuntimeVar("__CHATBOT_PRIMARY_COLOR__") ||
      "#132251",
